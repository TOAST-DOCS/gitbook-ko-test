...
(1) MariaDB이 설치된 서버에서 아래의 명령어를 이용하여 백업을 수행합니다.
...
RDS for MariaDB의 백업 파일을 이용하여 직접 MariaDB의 데이터베이스를 복원할 수 있습니다. RDS for MariaDB 백업 파일을 복원할 때 [백업](backup-and-restore/#_1) 항목을 참고하여 RDS for MariaDB에서 사용하는 Percona XtraBackup과 동일한 버전을 사용해야 합니다.
